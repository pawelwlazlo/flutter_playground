import 'package:easy_bank/data/bank/datasources/bank_data_source.dart';
import 'package:easy_bank/data/bank/datasources/user_data_source.dart';
import 'package:easy_bank/data/bank/repositiories/bank_account_repository_impl.dart';
import 'package:easy_bank/data/bank/repositiories/bank_transfer_repository_impl.dart';
import 'package:easy_bank/data/bank/repositiories/user_repository_impl.dart';
import 'package:easy_bank/domain/bank/repositories/bank_account_repository.dart';
import 'package:easy_bank/domain/bank/usecases/get_bank_accounts_use_case.dart';
import 'package:easy_bank/domain/bank_transfer/repositories/bank_transfer_repository.dart';
import 'package:easy_bank/domain/bank_transfer/usecases/get_transfers_use_case.dart';
import 'package:easy_bank/domain/login/repositories/user_repository.dart';
import 'package:easy_bank/domain/login/usecases/check_user_pin_use_case.dart';
import 'package:easy_bank/domain/login/usecases/get_user_use_case.dart';
import 'package:easy_bank/domain/login/usecases/read_user_use_case.dart';
import 'package:easy_bank/domain/login/usecases/save_user_use_case.dart';
